...
/*
1. Normal or Regular inner class: Phase3.inheritance.diamondProblem.A class created inside another class and outside the method without static modifier is called regular or normal inner class.
2. Method local inner class: Phase3.inheritance.diamondProblem.A class declared within a method of the outer class is called method local inner class.
3. Anonymous inner class: Phase3.inheritance.diamondProblem.A class declared without any name at all is called anonymous inner class.
4. Static nested inner class: Phase3.inheritance.diamondProblem.A class declared with static modifier within a class is called static nested inner class. It is also known as a top-level nested class. It can access only the static members of the outer class.
 */
public class OuterClass { //enclosing class; top level class
    ...
    //like University and Department. Department is part of University so user inner not Phase3.inheritance
...
/*
in here Phase3.inheritance.diamondProblem.A nested class in Java has access to the members ( including private members) of its enclosing class.
...
For example, an inner class Phase3.inheritance.diamondProblem.A is compiled into a class Test named Test$Phase3.inheritance.diamondProblem.A.class.
